...
export const TOUR_COPY: Record<TourStepId, Record<TourLang, TourStepContent>> = {
  ...
  discover: {
    ...
    ta: {
      ...
      features: [
        { label: 'பட்ஜெட் புரிதல்', detail: 'உங்கள் ரூபாய் வரம்புக்கு ஏற்ப முடிவுகள்.' },
  ...
  multimodal: {
    ...
    si: {
      ...
      features: [
        ...
        { label: 'ඉක්මන් යෝජනා', detail: 'ස්පර්ශයකින් උදාහරණ බලන්න.' },
      ],
    ...
    ta: {
      ...
      features: [
        ...
        { label: 'விரைவு பரிந்துரை', detail: 'ஒரு தொடுதலில் எடுத்துக்காட்டுகள்.' },
      ],
  ...
  checkout: {
    ...
    si: {
      ...
      lead: 'මුදල මිනිත්තු 60ක් තහවුරු කර ආරක්ෂිත Kapruka ද්වාර හරහා ගෙවන්න.',
      features: [
        { label: 'මිනිත්තු 60ක මිල තහවුරුව', detail: 'තීරණය ගන්නා තුරු LKR මුදල තහවුරුව.' },
        { label: 'ගෙවීම් සබැඳිය බෙදාගන්න', detail: 'WhatsApp හරහා පවුලට යවන්න.' },
        { label: 'බහු-මුදල්', detail: 'LKR, USD, GBP, AUD, CAD.' },
        { label: 'අමුත්තා ගෙවීම', detail: 'ගිණුමක් නැතිව ගෙවන්න.' },
      ],
    },
    ta: {
      title: 'நம்பிக்கையுடன் கட்டணம் செலுத்துங்கள்',
      lead: 'மொத்தத்தை 60 நிமிடங்கள் பூட்டி, பாதுகாப்பான Kapruka வழியாக செலுத்துங்கள்.',
      features: [
        { label: '60-நிமிட விலை பூட்டு', detail: 'முடிவு செய்யும் வரை LKR மொத்தம் பாதுகாக்கப்படும்.' },
        { label: 'கட்டண இணைப்பைப் பகிருங்கள்', detail: 'WhatsApp வழியாக குடும்பத்திற்கு அனுப்புங்கள்.' },
        { label: 'பலநாணய', detail: 'LKR, USD, GBP, AUD, CAD.' },
        { label: 'விருந்தினர் கட்டணம்', detail: 'கணக்கு இல்லாமல் செலுத்தலாம்.' },
      ],
    },
  },
  track: {
  ...
  remember: {
    ...
    si: {
      ...
      features: [
        ...
        { label: 'මායික් සබැඳි පිවිසුම', detail: 'මුරපද රහිත, ආරක්ෂිත ප්‍රවේශය.' },
      ],
    },
    ta: {
      ...
      features: [
        ...
        { label: 'மாய இணைப்பு உள்நுழைவு', detail: 'கடவுச்சொல் இல்லாத, பாதுகாப்பான அணுகல்.' },
      ],
    },
  },
};
...
export const TOUR_UI: Record<TourLang, {
  ...
  si: {
    ...
    readyLead: 'Kapruka භාණ්ඩ 120,000+ ත්‍රිභාෂා කතාබහ, බෙදාහැරීමේ පරීක්ෂා, සහ සජීවී නිරීක්ෂණය සමඟ ගවේෂණය කරන්න.',
  },
  ta: {
    ...
    readyLead: 'Kapruka 120,000+ பொருட்களை மும்மொழி உரையாடல், விநியோக சரிபார்ப்பு மற்றும் நேரலை கண்காணிப்புடன் ஆராயுங்கள்.',
  },
};
